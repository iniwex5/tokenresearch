export default {
  ...
  "planPro": "Pro (292)",
  "planTeam": "Team (332)",
  "planHint": "Select the plan manually. Tickets must match the selected length and pass actual model and global STATE proxy verification. Changing plans requires a new ticket.",
  ...
  "globalPoolHint": "This switch controls tickets for this account. Acquisition and verification use the global pool; normal requests keep this account's proxy when configured.",
  "proxy": "Harvest proxy",
  ...
  "proxyHint": "STATE acquisition and verification use only the global pool. Normal requests keep this account’s saved proxy when configured. Tickets are verified before use, valid for about one hour and refreshed before expiry.",
